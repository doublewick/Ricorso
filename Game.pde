 ...
 */
 ...
 class Game {
   ...
   private int maxGameLevels;                  //The maximum number of GameLevels this Game can sustain. Don't make GameLevels with an index >= this number.
   ...
   */
   ...
   public void startGame() {
     ...
     sm.setupGameLevel(this, players);   //Sets up top GameLevel - GameLevels take a list of players, so need to set up players first
